...
def downgrade() -> None:
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column(
                "ai_insights", sa.BOOLEAN(), server_default=sa.text("1"), nullable=False
            )
        )
    ...
    with op.batch_alter_table("ai_audit_logs", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("idx_ai_audit_user_timestamp"),
            ["user_id", "timestamp"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_ai_audit_status"),
            ["operation_status", "timestamp"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_ai_audit_session"),
            ["session_id", "timestamp"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_ai_audit_risk"), ["risk_score", "timestamp"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_ai_audit_operation_timestamp"),
            ["operation_type", "timestamp"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_ai_audit_compliance"),
            ["hipaa_applicable", "gdpr_applicable", "timestamp"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_ai_audit_classification"),
    ...
    with op.batch_alter_table("ai_operation_metrics", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("idx_metrics_period_model"),
            ["aggregation_period", "ai_model_used"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_metrics_performance"),
            ["avg_processing_time_ms", "error_rate"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_metrics_date_type"),
            ["metric_date", "operation_type"],
            unique=False,
        )
    ...
    with op.batch_alter_table("ai_compliance_reports", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_ai_compliance_reports_report_id"), ["report_id"], unique=1
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            batch_op.f("idx_compliance_score_status"),
            ["compliance_score", "status"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_compliance_framework_period"),
            ["compliance_framework", "period_start", "period_end"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_compliance_created"), ["created_at"], unique=False
        )
    ...
    with op.batch_alter_table("ai_data_access", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_ai_data_access_access_id"), ["access_id"], unique=1
        )
        batch_op.create_index(
            batch_op.f("idx_data_access_type_id"),
            ["data_type", "data_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_data_access_purpose"),
            ["access_purpose", "accessed_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_data_access_classification"),
            ["data_classification", "accessed_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_data_access_audit"),
            ["audit_log_id", "accessed_at"],
            unique=False,
        )
    ...
    with op.batch_alter_table("ai_security_events", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_ai_security_events_event_id"), ["event_id"], unique=1
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            batch_op.f("idx_security_user_detected"),
            ["user_id", "detected_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_security_type_detected"),
            ["event_type", "detected_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_security_severity_status"),
            ["severity", "status"],
            unique=False,
        )
