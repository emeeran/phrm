...
def get_database_config() -> Dict[str, Any]:
    ...
    database_uri = get_secret('SQLALCHEMY_DATABASE_URI') or get_secret('DATABASE_URL') or 'sqlite:///phrm.db'
...
def get_security_config() -> Dict[str, Any]:
    ...
    return {
        ...
        'SESSION_COOKIE_SECURE': (get_secret('SESSION_COOKIE_SECURE', 'False') or 'False').lower() == 'true',
...
class ProductionConfig(Config):
    ...
    def __init__(self) -> None:
        ...
        self.PERMANENT_SESSION_LIFETIME = timedelta(hours=2)  # Shorter session in production
